...
def robot_returns_to_origin(moves):
    ...
    for item in moves:
        # Unlike C++ or Java switch statements that require a break to prevent fall-through,
        # match...case automatically exits the match structure after executing a matching case.
        match item:
            case "U":
                y += 1
            case "D":
